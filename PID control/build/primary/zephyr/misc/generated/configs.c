...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PICOSDK_USE_ADC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_RPI_PICO2, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_RPI_PICO2_RP2350A_M33, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_RP2350A_M33, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_RPI_PICO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_DW_CLOCK_SPEED, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_DW_RW_TIMEOUT_MS, 100);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_SIZE, 0x3fff00);
