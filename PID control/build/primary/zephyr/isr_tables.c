...
const uintptr_t __irq_vector_table _irq_vector_table[52] = {
...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[52] = {
	...
	{(const void *)0x1000dbfc, (ISR)0x10006f55}, /* 21 */
	...
	{(const void *)0x1000dbdc, (ISR)0x1000d62d}, /* 33 */
	{(const void *)0x0, (ISR)z_irq_spurious}, /* 34 */
	{(const void *)0x1000dc1c, (ISR)0x10006985}, /* 35 */
	{(const void *)0x1000dc5c, (ISR)0x100071fd}, /* 36 */
	{(const void *)0x1000dc3c, (ISR)0x100071fd}, /* 37 */
