...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x10000000 + 0x100), LENGTH = (0x3fff00 - 0x0)
    RAM (wx) : ORIGIN = 0x20000000, LENGTH = (520 * 1K)
...
noinit (NOLOAD) :
{
    ...
    __kernel_ram_end = 0x20000000 + (520 * 1K);
